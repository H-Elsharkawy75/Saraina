...
//  }
  ...
  if ($(".square-menu").length) {
    ...
    //circular-menu
  if ($(".square-menu_two").length) {
    $(".square-menu_two .floating-btn").on("click", function () {
  ...
  // compareProduct Carousel
  if ($(".compareProduct-carousel").length) {
    $(".compareProduct-carousel").owlCarousel({
      loop: true,
      margin: 0,
      nav: true,
      smartSpeed: 500,
